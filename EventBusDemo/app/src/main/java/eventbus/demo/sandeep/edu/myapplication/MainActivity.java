...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendMessageToFragment(View view){
        ...
        GlobalOttoBus.getsBus().post(activityFragmentMessageEvent);
    }
    ...
    @Subscribe
    public void getMessage(Event.FragmentActivityMessage _fragmentActivityMessage){
        TextView messageView = (TextView) findViewById(R.id.message);
        messageView.setText(getString(R.string.message_received) + " " + _fragmentActivityMessage.getMessage());

        Toast.makeText(getApplicationContext(),
                getString(R.string.message_main_activity) + " " + _fragmentActivityMessage.getMessage(),
